...
import 'home_inspection_badge.dart';
...
class HomeHeroGlucoseCard extends StatelessWidget {
  ...
  const HomeHeroGlucoseCard({
    super.key,
    required this.glucose,
    this.inspectingPast = false,
  });
    ...
    return Padding(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            top: 0,
            child: HomeInspectionBadge(visible: inspectingPast),
          ),
        ],
      ),
    );
