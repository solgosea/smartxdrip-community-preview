...
class LowEpisodeRepeatCalculator {
  ...
  String _takeaway(EpisodeRepeatTimeBlockBucket dominant, int repeatCount) {
    if (repeatCount == 0 || dominant.count == 0) {
      return 'No clear repeated low-episode timing pattern is visible in the past 30 days.';
    }
    return 'Repeated low episodes are most visible around ${dominant.label.toLowerCase()}, so that time-of-day context is a good place to start review.';
  }
