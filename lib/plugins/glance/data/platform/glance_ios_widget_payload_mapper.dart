...
class GlanceIosWidgetPayloadMapper {
  ...
  Map<String, Object?> sharedPayload(
    ...
    return {
      ...
      GlanceIosWidgetPayloadKeys.tir24hLabel: payload.tir24hLabel,
      GlanceIosWidgetPayloadKeys.tir24hCompactLabel: payload.tir24hCompactLabel,
      GlanceIosWidgetPayloadKeys.tir24hPercent: payload.tir24hPercent,
      GlanceIosWidgetPayloadKeys.tir24hReadingCount: payload.tir24hReadingCount,
