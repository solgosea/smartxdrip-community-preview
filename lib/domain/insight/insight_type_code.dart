enum InsightTypeCode {
  ...
  weeklyPatternComparison('weekly_pattern_comparison'),
  weeklyPatternNoData('weekly_pattern_no_data'),
  ...
  glucotypeLow('glucotype_low'),
  glucotypeModerate('glucotype_moderate'),
  glucotypeSevere('glucotype_severe'),
  glucotypeTrendStable('glucotype_trend_stable'),
  glucotypeTrendChanged('glucotype_trend_changed'),
  glucotypeFactorNote('glucotype_factor_note'),
  glucotypeNoData('glucotype_no_data'),
